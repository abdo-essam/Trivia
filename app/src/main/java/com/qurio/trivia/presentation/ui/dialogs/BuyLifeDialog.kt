...
class BuyLifeDialog : DialogFragment() {

    private var _binding: DialogBuyLifeBinding? = null
    private val binding get() = _binding!!

    private var onPurchaseConfirmed: (() -> Unit)? = null
    ...
    fun setOnPurchaseConfirmedListener(listener: () -> Unit) {
        onPurchaseConfirmed = listener
    }
